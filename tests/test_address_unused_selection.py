...
def test_generate_address_first_unused_when_all_network_errors(monkeypatch):
...
def test_generate_address_skips_used_indices(monkeypatch):
...
def test_list_utxos_all_network_failures_includes_note(monkeypatch):
